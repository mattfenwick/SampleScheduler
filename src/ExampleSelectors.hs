...
randomPoints n s = genericSelect combTransSepQuad (const ()) (\_ -> selectNRandomly n s)
...
randomPointsAllQuadUnits n s = genericSelect combTransCombQuad (const ()) (\_ -> selectNRandomly n s)
